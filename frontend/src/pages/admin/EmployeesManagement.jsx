  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600">Manage employee profiles and details</p>
      </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-slate-200 bg-slate-50">
                    <th className="px-4 py-3 text-left text-slate-900 font-medium">Employee</th>
                    <th className="px-4 py-3 text-left text-slate-900 font-medium">Department</th>
                    <th className="px-4 py-3 text-left text-slate-900 font-medium">Email</th>
                    <th className="px-4 py-3 text-left text-slate-900 font-medium">Status</th>
                    <th className="px-4 py-3 text-left text-slate-900 font-medium">Points</th>
                    <th className="px-4 py-3 text-center text-slate-900 font-medium">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {employees.map((emp) => (
                    <tr key={emp._id} className="border-b border-slate-200 hover:bg-slate-100 transition">
                      <td className="px-4 py-3">
                        <div>
                          <p className="text-slate-900">{emp.firstName} {emp.lastName}</p>
      ...
      >
        {selectedEmployee && (
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between"><span className="text-slate-600">Total Bonus</span><span className="text-slate-900">${selectedEmployee.totalBonus || 0}</span></div>
          </div>
        )}
      </Modal>
